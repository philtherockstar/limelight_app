...
;
(function() {
  var load_my_js, ready_consultations, ready_home, ready_step1, ready_step2, ready_step3;
  ...
  ready_home = function() {
    ...
    $('#home_choose_property_go_button').click(function(e) {
      var my_bid;
      ...
      if ((my_bid != null)) {
        ...
        return $('.help-block').html("Please select one of the options");
      }
    });
    return $('#home_go_button').click(function(e) {
      var prop_id;
      ...
      if (prop_id === '0') {
        ...
        return $('.help-block').html("The address field doesn't have a valid address");
      } else {
        $("#home_form_prop_addr_group").removeClass('has-error').addClass('has-success');
        $('.help-block').html("Success!");
        console.log('yes');
  ...
  ready_consultations = function() {
    $('#property_city').change(function() {
      ...
      return $.ajax({
        ...
        success: function(data, status, response) {
          if (data.error === true) {
            return console.log('success but error');
          } else {
            if (data.length > 0) {
              ...
              return $('.help-block').html("This property is already in the database");
            } else {
    ...
    $('#property_sqft').change(function() {
      var sqft;
      sqft = $(this).val();
      if (isFinite(sqft) && parseInt(sqft) < 20000) {
        ...
        return $('.help-block').html("Square Feet must be a number < 20,000");
      }
    });
    $('#client_first_name').autocomplete({
      ...
      return $("<li>").data("item.autocomplete", item).append(item.first_name + " " + item.last_name).appendTo(ul);
    };
    ...
    return $('#consultations_save_button').click(function(e) {
      console.log('consultations_save_button clicked');
      return $('#consultations_form').submit();
    });
  };
  ...
  ready_step1 = function() {
    ...
    return $('#step1_next_button').click(function(e) {
      console.log('step1_next_button clicked');
      return $('#step1_form').submit();
    });
  };

  ready_step2 = function() {
    var calc_room_total;
    calc_room_total = function() {
      var sum;
      console.log("calculating room total");
      sum = 0;
      return $('.bid_room_fee_total').each((function(_this) {
        return function(index, element) {
          sum += parseFloat($(element).text());
          return $('.bid_rooms_fee').text(sum);
        };
      })(this));
    };
    calc_room_total();
    $('.number_of_rooms').change(function() {
      var id, num_rooms, room_price;
      num_rooms = $(this).val();
      id = $(this).attr('id').match(/.*_(\d*)/)[1];
      console.log("number of rooms changed for " + id);
      if (isFinite(num_rooms) && parseInt(num_rooms) < 11) {
      ...
      return calc_room_total();
    });
    $('.room_prices').change(function() {
      var id, num_rooms, room_price;
      room_price = $(this).val();
      id = $(this).attr('id').match(/.*_(\d*)/)[1];
      console.log("room price changed for " + id);
      console.log("room price is " + room_price);
      if (isFinite(room_price) && parseInt(room_price) < 20000) {
    ...
    $('#step2_next_button').click(function(e) {
      var submitme;
      ...
      if (submitme) {
        return $('#step2form').submit();
      }
    });
    return $('form').on('keyup', function(e) {
      if (e.which === 13) {
        e.preventDefault;
        return false;
      }
  ...
  ready_step3 = function() {
    ...
    $('.items_form_button').click(function(e) {
      $('#items_form_action').val($(this).attr('name'));
      return $('form').submit();
    });
    $('.bid_room_item_quantity').change(function() {
      var id, qty, rental_price;
      qty = $(this).val();
      id = $(this).attr('id').match(/.*_(\d*_\d*_\d*)/)[1];
    ...
    $('.bid_room_item_rental_price').change(function() {
      var id, qty, rental_price;
      rental_price = $(this).val();
      id = $(this).attr('id').match(/.*_(\d*_\d*_\d*)/)[1];
    ...
    return $('.add_item_to_rooms').click(function(e) {
      var last_row_number, new_row_number, newrow, room_id, room_number;
      ...
      $('#bid_rooms_item_' + room_id + "_" + room_number + "_" + new_row_number).autocomplete({
        ...
        source: '/item',
        select: function(event, ui) {
          var item_name, qty, qty_name, rental_name, row_number;
          room_id = $(this).data('room-id');
          room_number = $(this).data('room-number');
        ...
        return $("<li>").data("item.autocomplete", item).append(item.name + " $" + item.rental_price).appendTo(ul);
      };
      $('.bid_room_item_quantity').change(function() {
        var id, qty, rental_price;
        qty = $(this).val();
      ...
      return $('.bid_room_item_rental_price').change(function() {
        var id, qty, rental_price;
        rental_price = $(this).val();
        id = $(this).attr('id').match(/.*_(\d*_\d*_\d*)/)[1];
        qty = $("#bid_rooms_item_quantity_" + id).val();
